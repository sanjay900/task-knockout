module TaskKnockout
  class Cli < Thor
    ...
    def filter(filter_id)
      search = TaskKnockout.api_client.search_by_filter(filter_id)
    ...
    def filters
      data = TaskKnockout.api_client.my_filters
    ...
    def issue(issue_id)
      issue = TaskKnockout.api_client.issue(issue_id,
    ...
    def issue_transitions(issue_id)
      data = TaskKnockout.api_client.issue_transitions(issue_id)
    ...
    def myself
      puts TaskKnockout.api_client.myself.to_yaml
    end
    ...
    def show_filter(filter_id)
      filter = TaskKnockout.api_client.filter(filter_id)
      data = {
        id: filter[:id],
        name: filter[:name],
    ...
    def transition(issue_id, transition_id)
      if transition_id.match /[a-zA-Z]/
        ...
        response = TaskKnockout.api_client.issue_transitions(issue_id)
      ...
      data = TaskKnockout.api_client.transition(issue_id, transition_id)
      puts data.to_yaml
    end
